    ...
    <div className="mb-4 sm:mb-6">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-between relative">
          ...
          {/* Step Connectors - visible on all screens now */}
          <div className="absolute top-4 sm:top-5 left-5 right-5 flex justify-between z-0">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex-1 relative h-0.5 mx-1 sm:mx-5">
            ...
            {step === 1 && (
              ...
              >
                ...
                <motion.button
                  ...
                  className={`flex-shrink-0 regular h-10 sm:h-12 px-4 regular sm:px-6 rounded-lg text-sm transition-colors shadow-sm ${selectedService
