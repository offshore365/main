      ...
      faqs: [
        {
          ...
          icon: (
            <svg
              ...
              className="h-12 w-12 text-[#3A8CA1]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.div
        ...
        className={`z-20 bg-[#3A8CA1] backdrop-blur-xl shadow-lg transition-all duration-300 ${isSticky ? "fixed top-[64px] left-0 right-0 shadow-xl" : "relative"
          }`}
      >
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center py-3 gap-2 sm:gap-3 flex-wrap">
            ...
            ${activeTab === tab.id
                    ? "bg-[#7AC1CD] text-[#3A8CA1] font-semibold"
                    : "text-white hover:bg-[#7AC1CD] hover:text-[#3A8CA1]"
                  }`}
              >
                {tab.label}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 sm:gap-4 lg:gap-6 sm:justify-items-center">
                  ...
                  <div className="overflow-x-auto pb-4" id="mobile-plans-scroll">
                    <div className="flex gap-4 px-2" style={{ width: 'max-content' }}>
                      {tabData.plans.plans.slice(0, 5).map((plan, index) => (
                        <div
                          key={index}
                          className="group relative flex-shrink-0 w-[280px] h-[200px] bg-[#3A8CA1] shadow-lg hover:shadow-2xl rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105"
                          style={{
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center justify-center h-full text-white px-6">
                            ...
                            <button
                              ...
                              className="w-full py-2.5 text-base rounded-lg bg-white text-[#3A8CA1] font-regular transition duration-300 hover:bg-gray-100 hover:shadow-md active:scale-95"
                            >
                              Get started
                            </button>
                ...
                {tabData.plans.plans.slice(0, 5).map((plan, index) => (
                  <div
                    key={index}
                    className="group relative hidden sm:block w-full max-w-[280px] sm:w-[250px] lg:w-[240px] xl:w-[250px] h-[180px] sm:h-[200px] lg:h-[220px] xl:h-[200px] bg-[#3A8CA1] shadow-lg hover:shadow-2xl rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105"
                    style={{
                      border: "2px solid transparent",
                    }}
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center justify-center h-full text-white px-4 sm:px-6">
                      ...
                      <button
                        ...
                        className="w-full py-2 sm:py-2.5 text-sm sm:text-base lg:text-[16px] rounded-lg bg-white text-[#3A8CA1] font-regular transition duration-300 hover:bg-gray-100 hover:shadow-md active:scale-95"
                      >
                        Get started
                      </button>
    ...
    .overflow-x-auto {
      ...
      scrollbar-color: #3A8CA1 transparent;
    }
                  ...
                  {tabData["why-us"].highlightedBenefits.map((benefit, index) => (
                    ...
                    >
                      <div className="flex items-start mb-2">
                        <div className="bg-[#7AC1CD] rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0 mt-0.5">
                          <svg
                            className="w-3 h-3 sm:w-4 sm:h-4 text-[#3A8CA1]"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-[#1F3B4D]">
                  {[
                    ...
                    <div
                      ...
                      data-aos-delay={index * 100}
                    >
                      <div className="bg-[#7AC1CD] rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0 ">
                        <svg
                          className="w-3 h-3 sm:w-4 sm:h-4 text-[#3A8CA1]"
                          fill="none"
                          stroke="currentColor"
                    ...
                    {tabData.faq.faqs.map((faq, index) => (
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          <div className="mt-1 flex-shrink-0 text-[#3A8CA1]">{faq.icon}</div>
