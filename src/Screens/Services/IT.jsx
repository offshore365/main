            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 sm:gap-4 lg:gap-6 sm:justify-items-center">
                  ...
                  <div className="overflow-x-auto pb-4" id="mobile-plans-scroll">
                    <div className="flex gap-4 px-2" style={{ width: 'max-content' }}>
                      {tabData.plans.plans.slice(0, 5).map((plan, index) => (
                        <div
                          key={index}
                          className="group relative flex-shrink-0 w-[280px] h-[200px] bg-[#8F6FFF] shadow-lg hover:shadow-2xl rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105"
                          style={{
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col items-center text-center justify-center h-full text-white px-6">
                            ...
                            <button
                              ...
                              className="w-full py-2.5 text-base rounded-lg bg-white text-[#8F6FFF] font-regular transition duration-300 hover:bg-gray-100 hover:shadow-md active:scale-95"
                            >
                              Get started
                            </button>
                ...
                {tabData.plans.plans.slice(0, 5).map((plan, index) => (
                  <div
                    key={index}
                    className="group relative hidden sm:block w-full max-w-[280px] sm:w-[250px] lg:w-[240px] xl:w-[250px] h-[180px] sm:h-[200px] lg:h-[220px] xl:h-[200px] bg-[#8F6FFF] shadow-lg hover:shadow-2xl rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105"
                    style={{
                      border: "2px solid transparent",
                    }}
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center justify-center h-full text-white px-4 sm:px-6">
                      ...
                      <button
                        ...
                        className="w-full py-2 sm:py-2.5 text-sm sm:text-base lg:text-[16px] rounded-lg bg-white text-[#8F6FFF] font-regular transition duration-300 hover:bg-gray-100 hover:shadow-md active:scale-95"
                      >
                        Get started
                      </button>
