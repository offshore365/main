  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.div
        ...
        className={`z-20 bg-[#8F8A75] backdrop-blur-xl shadow-lg transition-all duration-300 ${isSticky ? "fixed top-0 left-0 right-0 shadow-xl" : "relative"
          }`}
      >
...
we make admin work efficient for  your brand by providing virtual admin <br /> service solutions tailored specifically to your business needs.
                ...
                {[
  {
    ...
    desc: "Stay organized with timely and professional email support.",
    delay: 0,
  },
  {
    title: "Report Management",
    desc: "Accurate reports delivered on time for better decisions.",
    delay: 100,
  },
  {
    title: "Managing Spreadsheets",
    desc: "Track and organize data efficiently with smart sheets.",
    delay: 200,
  },
  {
    title: "Invoice Management",
    desc: "Handle billing tasks with timely invoicing and tracking.",
    delay: 300,
  },
  {
    title: "CRM Management",
    desc: "Keep customer data updated and relationships on track.",
    delay: 400,
  },
  {
    title: "Document Management",
    desc: "Securely organize and manage your important files.",
    delay: 500,
  },
  {
    title: "Calendar Management",
    desc: "Stay on schedule with streamlined calendar support.",
    delay: 600,
  },
  {
    title: "Project Coordination",
    desc: "Align your team and tasks with smooth coordination.",
    delay: 700,
  }
]
                    ...
                    >
                      ...
                      <div className="mt-4 flex justify-end">
                        <button
                          ...
                          className="group flex items-center text-[#8F8A75] bg-[#E3E0D6]/60 rounded-full px-4 py-2 text-sm transition-all duration-300"
                        >
...
.map((service, index) => (
                      ...
                      >
                        ...
                        <div className="flex justify-end">
                          <button
                            onClick={scrollToGetStarted}
                            className="group flex items-center text-[#8F8A75] bg-[#E3E0D6]/60 rounded-full px-3 py-1.5 text-sm transition-all duration-300"
                          >
                            <span className="mr-2 regular">Book a Quote</span>
                            <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300" />
                          </button>
                ...
                <div className="flex justify-center items-center gap-4 mt-4">
                  <button
                    ...
                    className="w-8 h-8 rounded-full bg-[#8F8A75] text-white flex items-center justify-center shadow-md hover:scale-110 transition-all"
                  >
